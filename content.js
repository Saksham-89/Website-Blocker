  ...
  <section class="error">
    ...
    <div class="error__content">
      <div class="error__message message">
        <h1 class="message__title" >Go Back To Studying lol</h1>
        <p class="message__text">Stop Wasting Time On ${name} </p>
      </div>
    <!-- END Content -->
    ...
    margin-top: 20px;
        ...
        switch(window.location.hostname){
            ...
            case "www.instagram.com":
                    ...
                    break;
            case "www2.movies7.to":
                document.head.innerHTML = generateStyles()
                document.body.innerHTML = generatehtml("Movies7")
                break;
            case "ww2.putlocker.fan":
                document.head.innerHTML = generateStyles()
                document.body.innerHTML = generatehtml("Putlocker")
                break;
        }
